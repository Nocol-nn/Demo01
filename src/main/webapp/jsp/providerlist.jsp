...
<div class="right">
    ...
    <div class="search">
        <form method="post" action="${pageContext.request.contextPath }/provider/search">
            <input type="hidden" style="width: 40%" name="pageIndex" value="${pageInfo.pageNum}"/>
            ...
            <a style="margin: 10px auto" href="${pageContext.request.contextPath }/jsp/provideradd.jsp">添加供应商</a>
            <a style="margin:10px auto;background: #47acf1 url(../images/eye.png) 10px center no-repeat;
                width: 100px"
               href="${pageContext.request.contextPath }/provider/removeUI">查看移除供应商</a>
        </form>
    </div>
    <!--供应商操作表格-->
        ...
        <c:forEach var="provider" items="${providerList }" varStatus="status">
            <tr>
                ...
                <td>
                    ...
                    <span><a class="removeProvider" href="javascript:;"
                             proid=${provider.id } proname=${provider.proName }><img
                            src="${pageContext.request.contextPath }/images/yichu.png" alt="移除" title="移除"/></a></span>
